...
Perro::Perro(string n, float p, int genero, int p_g, int razaRef, bool v)
    : Mascota(n, p, genero, p_g) {
  switch (razaRef) {
  case 1:
...
float Perro::obtenerRD() { return getPeso() * 0.025; }
...
bool Perro::getVacu() { return vacunaCachorro; }
